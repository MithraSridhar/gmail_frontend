    ...
    >
      {({ TransitionProps }) => (
        <Fade {...TransitionProps} timeout={350}>
          <Paper>
            <Typography sx={{ p: 2 ,bgcolor: 'black' , color: 'white', textAlign: 'center'}}>
<div width= "500px" height = "4000px">

  <p>{userEmail}</p>
  <img src={user?.photoUrl} height="32px" width="32px" style={{borderRadius:50}}></img> 
  <p>Hi, {userName}!</p>
  <Button variant="contained">Manage your Google Account</Button>
  <br></br>
  <br></br>
    ...
    <div className="header">
      ...
      <div className="header-right">
        ...
        <IconButton>
          ...
          <img onClick={handleClick('left-start')}  src={user?.photoUrl} height="32px" width="32px" style={{borderRadius:50}}></img> 
